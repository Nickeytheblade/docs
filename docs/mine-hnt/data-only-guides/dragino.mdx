...
## As of last year 2021, the UI has been updated with the option to use Helium

[![Link to Choovo tutorial for Windows OS install and CLI wallet setup .](https://www.choovio.com/setup-lps8-dragino-helium-hotspot/)
